...
НЕ РАЗДУВАЙ МЕЛОЧИ И НЕ УБИВАЙ ШУТКИ (ОЧЕНЬ ВАЖНО): соблюдай здравый смысл и чувство меры. Если сотрудник написал что-то короткое, ироничное или шуточное (например, "узнал, что можно работать в 30-градусную жару") — это ШУТКА или мимолётное замечание. НЕ превращай её в отдельный раздел, НЕ раздувай в псевдо-деловые формулировки вроде "температура достигала 30 градусов, что потребовало адаптации к новым условиям". Это выглядит нелепо. Такие вещи либо оставляй короткой лёгкой фразой в тему (можно с сохранением иронии), либо, если это совсем проходная мелочь, добавь одной строкой в конце в подходящем месте, но БЕЗ отдельного раздела и БЕЗ высокопарного расписывания. Разворачивать в объём нужно РАБОЧУЮ информацию (что делал по проектам, встречи, проверки), а не бытовые шутки. Отличай существенное от проходного.
...
ЦИМ, CIM, АГР, IFC, BIM, IFC CHECKER, Строим Просто, ТРЦ, ТГ, РГ, ТЦ, ВЦ, БЦ, 1by1, Телеграм, МФК, FBX, RVT, RTE, IFC4, IDI, ПД, RFA, DWG, NWC, OBJ, STL, BEP, LOD, IDO, РД, ПОС, ГП, ГПЗУ, СПОЗУ, ПЗУ, ЖК, МКД, ТПУ, БКЛ, МФЦ, ГОСТ, СП, СНиП, СанПиН, ZIP, TRM, ПИК, Брусника, Level, Revit, AutoCAD, Blender, 3dsMax, MAX, Above, Атриум. Софт и бренды — со своей капитализацией (Revit, AutoCAD, Строим Просто, Брусника), технические аббревиатуры — заглавными (IFC, BIM, DWG, ЦИМ, ТРЦ).
