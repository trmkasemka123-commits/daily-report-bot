...
- Для КАЖДОГО проекта, над которым работал сотрудник, создавай ОТДЕЛЬНЫЙ раздел с тем, что по нему сделано.
...
- Названия проектов склоняй грамматически верно и пиши с большой буквы: "Работа над ЖК Нагатинский", "Работа над школой Бухвостова", "Работа над производственным кластером".
...
• Провёл доработку и исправление замечаний по объекту ПИК Саларьево на тестовом стенде в ЦИМЧЕКе. Замечания устранены, работа на данном этапе завершена.

Встреча с заказчиком по производственному кластеру
