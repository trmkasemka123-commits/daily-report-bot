...
- Заголовок раздела — отдельной строкой, без символа • и без номеров. Первое слово заголовка с ЗАГЛАВНОЙ буквы (например "Работа над проектом...", "Проверка моделей", "Взаимодействие"). Заголовок НЕ пиши целиком строчными буквами.
