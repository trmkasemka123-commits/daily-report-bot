...
- Аббревиатуры и названия ПО приводи к общепринятому правильному написанию независимо от того, как их набрал сотрудник (например: ЦИМ, ЦИМ Чекер, IFC, BIM, DWG, 1by1, ТРЦ, ЖК, Revit, AutoCAD, Строим Просто). Технические аббревиатуры — заглавными, софт и бренды — со своей капитализацией.
...
HELP_TEXT = (
    ...
    "/report — начать опрос\n"
    "/cancel — прервать\n"
    "/notifications — включить или отключить напоминание об итоге дня (18:30)"
)
